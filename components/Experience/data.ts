  ...
  Work: [
    {
      ...
      endDate: "Present",
      description: [
        "Designed and implemented client-focused solutions for Zoho platforms, addressing complex business needs.",
        "Developed scalable workflows using JavaScript, TypeScript, and Zoho Deluge.",
        "Integrated APIs for OCR, PDF processing, and data visualization to enhance user experience.",
        "Collaborated with clients and cross-functional teams to translate business requirements into technical solutions, ensuring alignment with development goals.",
        "Delivered scalable and efficient solutions through collaborative team efforts.",
      ],
      urls: [], // Add any relevant URLs if applicable
    },
    {
