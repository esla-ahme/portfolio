export const projectsData = [
  {
    title: "Dawinee Medical Appointment System",
    description:
      "A responsive medical booking system designed to facilitate real-time appointment scheduling and management. The system includes advanced filtering for appointments and user-friendly multi-language support.",
    role: [
      "Designed and implemented a responsive medical booking system with real-time updates.",
      "Built advanced filtering for appointments to improve user experience.",
      "Integrated WebSocket for instant communication and system notifications.",
      "Added multi-language support to cater to a diverse user base.",
    ],
    techStack: [
      "React",
      "Mateor.js",
  ...
  },
  {
    ...
    link: "https://darispace.com",
  },
  {
    title: "Twitter-Like Social Network",
    description:
    ...
    link: "https://github.com/Abdallah-Elshamy/Twitter-Like-App",
  },
  {
    title: "Search Academy Website",
    description:
    ...
    link: "https://www.search-academy.com",
  },
];
...
export const otherProjectsData = [
  {
    title: "Book Stores API",
    description:
      "A bookshop API for managing books and stores, supporting all CRUD operations and insures data consistency ",
    techStack: ["Node.js", "Express", "PostgreSQL", "Winston", "Swagger"],
    link: "https://github.com/esla-ahme/node-express-postgresql-bookAPI",
  },
  {
    title: "Groceries App ",
    description:
    ...
    link: "https://github.com/esla-ahme/Online-Store-React-Native",
  },
  {
    title: "Wordle Clone",
    description:
    ...
    techStack: ["React"],
    link: "https://github.com/esla-ahme/wordle-clone",
    live: "https://wordle-forever.netlify.app/",
  },
  {
    ...
    techStack: ["C++", "Qt", "QML", "JavaScript"],
    link: "https://github.com/esla-ahme/OS-Memory-Allocation-Process-Segmentation",
  },
  {
    title: "AYB App",
    description:
    ...
    techStack: ["Android", "Java", "Firebase", "Picasso"],
    link: "https://github.com/esla-ahme/aybappnew",
  },
  {
    title: "Miwok App",
    description:
    ...
    link: "https://github.com/esla-ahme/Miwok_Translation",
  },
  {
  ...
  },
  {
    ...
    description:
      "An Android app for testing your English language skills. Sign in using Firebase mobile or Google authentication, browse categories, add items to your quiz, and get your results.",
    techStack: ["Android", "Java"],
    link: "https://github.com/esla-ahme/QuizAPPAndroidND",
  },
];
